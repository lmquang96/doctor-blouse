...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
  ...
  <ul class="nav">
    ...
    <li class="nav-item menu-items">
      <a class="nav-link" data-bs-toggle="collapse" href="#nav-blog" aria-expanded="false" aria-controls="nav-blog">
        <span class="menu-icon">
      ...
      <div class="collapse" id="nav-blog">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{ route('blogCategory.index') }}">Category</a></li>
          <li class="nav-item"> <a class="nav-link" href="{{ route('blog.index') }}">List</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item menu-items">
