        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Create New Blog Category </h3>
            ...
            <div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Blog Category's Information</h4>
                    <form action="{{ route('blogCategory.store') }}" method="POST" class="form-sample">
                      @csrf
                      <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              ...
                              <x-input-error for="status" class="mt-2 mb-0" />
                            </div>
                          </div>
                        </div>
                      </div>
